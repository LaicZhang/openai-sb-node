...
=======
This is a modified version of the openai library. It is modified to work with the OpenAI-SB API. The original README is below.
>>>>>>> 18f21a8ecf72ff00f3bd78df8938eba15b9cfb62
...
> ⚠️ **Important note: this library is meant for server-side usage only, as using it in client-side browser code will expose your secret API key. [See here](https://platform.openai-sb.com/docs/api-reference/authentication) for more details.**

## Installation

```bash
npm install openai-sb
```

## Usage

The library needs to be configured with your account's secret key, which is available in your [OpenAI account page](https://platform.openai-sb.com/account/api-keys). We recommend setting it as an environment variable. Here's an example of initializing the library with the API key loaded from an environment variable and creating a completion:

```javascript
const { Configuration, OpenAIApi } = require("openai-sb");
...
Check out the [full API documentation](https://platform.openai-sb.com/docs/api-reference?lang=node.js) for examples of all the available functions.
